 ...
 *
 * Pushes are received from the client over websocket
...
/**
 * While pushing to the user's API server, additional pushes can
 * stack up. The pushes being stacked up are added to a queue
...
/**
 * Collapses pushes into a single push where the JWT is the same.
 * Order is preserved.
